...
/**
 * SchedulesDaysSearch represents the model behind the search form of `\app\models\SchedulesDays`.
 */
class SchedulesDaysSearch extends SchedulesDays
{
    /**
     * {@inheritdoc}
     */
